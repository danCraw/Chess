...
//    private String symbol = "I";
    ...
    private final ArrayList<GroveType> allowedGrove = Stream.of(GroveType.riverCross, GroveType.earth)
    ...
    public Infantry(Node currentNode) {
        super(currentNode);
        initInfantry();
    }
}
